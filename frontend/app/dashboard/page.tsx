...
export default function Dashboard() {
  ...
  const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
    {
      sender: 'ai',
      text: "👋 Welcome to Cortex Intel Copilot!\n\nTo begin analyzing clinical data, **please paste your Gemini API Key from Google AI Studio in the Settings tab.**\n\nOnce connected, you can ask me to evaluate patient risks, summarize FDA recalls, or compare global health metrics."
    }
  ]);
  ...
  const handleAskAI = async (e: React.FormEvent) => {
    ...
    if (!apiKey.trim()) {
      setChatHistory(prev => [...prev, { 
        sender: 'ai', 
        text: "Access Denied: Please paste your Gemini API key from Google AI Studio in the Settings tab to use the Cortex Intel AI Chatbot."
      }]);
      addLog("AI Query rejected: Missing Gemini API key.");
      return;
    }
